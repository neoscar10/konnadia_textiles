                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-slate-100 text-slate-800 border border-slate-200">
                                    {{ $w->unitModel ? $w->unitModel->name . ' (' . $w->unitModel->short_code . ')' : $w->unit }}
                                </span>
                            </td>
                            <td class="px-6 py-4">
        ...
        <form wire:submit="saveWidth" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    @error('unit_id') <span class="text-xs text-rose-600 mt-1 font-semibold block">{{ $message }}</span> @enderror
                </div>
            </div>
