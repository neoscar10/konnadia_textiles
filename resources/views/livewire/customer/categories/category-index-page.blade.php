<div>
    ...
    <div class="mb-8 max-w-md">
        <div class="relative w-full">
            ...
            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search categories..." class="w-full bg-white text-[#001229] placeholder-slate-400 pl-10 pr-4 py-2.5 rounded-xl text-sm border border-outline-variant/30 focus:outline-none focus:ring-2 focus:ring-gold shadow-ambient">
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($categories as $cat)
            ...
            />
        @empty
            <div class="col-span-full bg-white rounded-xl p-8 text-center text-slate-400 border border-outline-variant/20">
