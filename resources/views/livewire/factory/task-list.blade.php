                            ...
                            <div class="pt-3 border-t border-outline-variant/40 space-y-3">
                                <div>
                                    ...
                                    @error('labor_category_id')
                                        <span class="text-error text-xs block mt-1 font-semibold">{{ $message }}</span>
                                    @enderror
                                    <p class="text-[11px] text-on-surface-variant mt-1 font-medium">Select the labour category that performs this manufacturing task (e.g., Tailor, Cutter, Laundry Person).</p>
                                </div>
                            </div>
                        @endif
                    </div>
