<div>
    @if($showModal)
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4 z-50">
            <div class="bg-surface-container-lowest border border-outline-variant/60 rounded-2xl shadow-xl w-full max-w-lg overflow-hidden" @click.outside="$wire.closeModal()">
                <!-- Header -->
