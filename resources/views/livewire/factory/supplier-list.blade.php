<div class="space-y-6 max-w-7xl mx-auto pb-12">
    ...
    <div class="p-4 bg-surface rounded-2xl border border-outline-variant/60 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-4">
        <div class="relative w-full sm:w-48">
            ...
            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search suppliers..." class="w-full bg-surface-container-lowest border border-outline-variant/60 rounded-xl pl-10 pr-4 py-2 text-xs font-bold text-on-surface focus:outline-none focus:ring-2 focus:ring-primary/20">
        </div>
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 sm:p-6">
                <div class="relative bg-surface rounded-2xl border border-outline-variant/60 shadow-2xl w-full max-w-xl overflow-hidden my-8 max-h-[calc(100vh-4rem)] flex flex-col" @click.outside="$wire.set('showModal', false)">
                    ...
                    <form wire:submit.prevent="saveSupplier" class="p-6 space-y-4 overflow-y-auto flex-1 min-h-0">
                        <!-- Supplier Name -->
                        <div>
