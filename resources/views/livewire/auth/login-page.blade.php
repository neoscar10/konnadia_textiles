        ...
        <section class="w-full md:w-[45%] h-full min-h-screen flex items-center justify-center bg-surface p-xl relative">
            <div class="w-full max-w-md">
                ...
                <div class="bg-surface-container-lowest rounded-xl p-xl shadow-sm border border-outline-variant/30 card-shadow">
                    ...
                    <form class="space-y-lg" method="POST" action="{{ route('login.store') }}">
                        @csrf
                        ...
                        <div class="space-y-xs">
                            ...
                            <div class="relative group">
                                <input name="email" value="{{ old('email') }}" class="w-full h-[48px] px-md rounded-lg border border-outline-variant bg-surface-container-low focus:ring-2 focus:ring-secondary/20 focus:border-secondary transition-all outline-none text-on-surface" id="email" type="email" placeholder="e.g. admin@kannodiatextiles.com" required/>
                            </div>
                        </div>
                        ...
                        <div class="space-y-xs">
                            ...
                            <div class="relative group" x-data="{ show: false }">
                                <input name="password" :type="show ? 'text' : 'password'" class="w-full h-[48px] px-md rounded-lg border border-outline-variant bg-surface-container-low focus:ring-2 focus:ring-secondary/20 focus:border-secondary transition-all outline-none text-on-surface pr-12" id="password" placeholder="••••••••" required/>
                        ...
                        <div class="flex items-center justify-between py-xs">
                            <label class="flex items-center gap-sm cursor-pointer group">
                                <input name="remember" type="checkbox" value="1" {{ old('remember') ? 'checked' : '' }} class="w-4 h-4 rounded border-outline-variant text-secondary focus:ring-secondary cursor-pointer"/>
