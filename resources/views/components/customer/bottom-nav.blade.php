<nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-outline-variant/30 px-2 py-1 pb-safe z-50 flex items-center justify-around shadow-lg">
    <!-- Home Tab -->
    <a href="{{ route('customer.dashboard') }}" class="flex flex-col items-center gap-0.5 py-1 px-3 rounded-xl transition-all {{ request()->routeIs('customer.dashboard') ? 'text-gold' : 'text-slate-500' }}">
    ...
    <!-- Products Tab -->
    <a href="{{ route('customer.products.index') }}" class="flex flex-col items-center gap-0.5 py-1 px-3 rounded-xl transition-all {{ request()->routeIs('customer.products.*') || request()->routeIs('customer.categories.*') ? 'text-gold' : 'text-slate-500' }}">
    ...
    <!-- Cart Tab -->
    <a href="{{ route('customer.cart.index') }}" class="relative flex flex-col items-center gap-0.5 py-1 px-3 rounded-xl transition-all {{ request()->routeIs('customer.cart.index') ? 'text-gold' : 'text-slate-500' }}">
    ...
    <!-- Orders Tab -->
    <a href="{{ route('customer.orders.index') }}" class="flex flex-col items-center gap-0.5 py-1 px-3 rounded-xl transition-all {{ request()->routeIs('customer.orders.*') ? 'text-gold' : 'text-slate-500' }}">
    ...
    <!-- Profile Tab -->
    <a href="{{ route('customer.profile.show') }}" class="flex flex-col items-center gap-0.5 py-1 px-3 rounded-xl transition-all {{ request()->routeIs('customer.profile.show') || request()->routeIs('customer.profile.change-password') ? 'text-gold' : 'text-slate-500' }}">
