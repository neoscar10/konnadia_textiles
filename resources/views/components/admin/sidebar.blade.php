    ...
    <div class="flex-1 overflow-y-auto py-lg flex flex-col gap-sm admin-sidebar-scroll"
        ...
        @if(auth()->user()->hasAnyRole(['super_admin', 'admin', 'Factory Supervisor']) || auth()->user()->can('manage_labor'))
            ...
            <nav class="flex flex-col gap-xs px-sm">
                ...
                <a href="{{ route('admin.production.customized') }}" wire:navigate class="flex items-center rounded-lg transition-all duration-200 {{ request()->routeIs('admin.production.customized*') ? 'is-active-link bg-primary-container text-on-primary font-title-md shadow-sm' : 'text-on-primary/70 hover:text-on-primary hover:bg-primary-container/30' }}" :class="sidebarOpen ? 'gap-md px-md py-sm' : 'justify-center p-sm mx-xs'">
                ...
                <!-- Leaf Category Config (Standalone) -->
                <a href="{{ route('admin.production.front-end-products') }}" wire:navigate class="flex items-center rounded-lg transition-all duration-200 {{ request()->routeIs('admin.production.front-end-products') ? 'is-active-link bg-primary-container text-on-primary font-title-md shadow-sm' : 'text-on-primary/70 hover:text-on-primary hover:bg-primary-container/30' }}" :class="sidebarOpen ? 'gap-md px-md py-sm' : 'justify-center p-sm mx-xs'">
                    <span class="material-symbols-outlined shrink-0" data-icon="category">category</span>
                    <span class="font-label-md text-label-md" x-show="sidebarOpen">Leaf Category Config</span>
                </a>

                <!-- Spare Products (Standalone) -->
                <a href="{{ route('admin.production.spare-products') }}" wire:navigate class="flex items-center rounded-lg transition-all duration-200 {{ request()->routeIs('admin.production.spare-products') ? 'is-active-link bg-primary-container text-on-primary font-title-md shadow-sm' : 'text-on-primary/70 hover:text-on-primary hover:bg-primary-container/30' }}" :class="sidebarOpen ? 'gap-md px-md py-sm' : 'justify-center p-sm mx-xs'">
                    <span class="material-symbols-outlined shrink-0" data-icon="inventory">inventory</span>
                    <span class="font-label-md text-label-md" x-show="sidebarOpen">Spare Products</span>
                </a>
                ...
                <!-- Raw Materials Group -->
                <div x-data="{ open: {{ request()->routeIs('factory.suppliers.*') || request()->routeIs('factory.raw-materials.*') || request()->routeIs('factory.fabric-widths.*') || request()->routeIs('admin.units.*') || request()->routeIs('factory.units.*') ? 'true' : 'false' }} }" class="flex flex-col">
                    <button @click="open = !open; if(!sidebarOpen && open) sidebarOpen = true;" type="button" class="flex items-center justify-between rounded-lg transition-all duration-200 text-on-primary/70 hover:text-on-primary hover:bg-primary-container/30 w-full" :class="sidebarOpen ? 'px-md py-sm' : 'justify-center p-sm mx-xs'">
                        <div class="flex items-center gap-md">
                    ...
                    <div x-show="open && sidebarOpen" x-collapse x-cloak>
                        <div class="flex flex-col gap-1 pl-11 pr-2 py-1 relative before:absolute before:left-[22px] before:top-0 before:bottom-0 before:w-px before:bg-on-primary/10">
                            ...
                            <a href="{{ route('factory.suppliers.index') }}" wire:navigate class="px-3 py-2 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('factory.suppliers.*') ? 'is-active-link bg-primary-container/40 text-on-primary font-bold' : 'text-on-primary/70 hover:text-on-primary hover:bg-primary-container/20' }}">
                                Suppliers
                            </a>
