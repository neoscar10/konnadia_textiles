...
class UpdateManufacturingProductRequest extends FormRequest
{
    ...
    {
        $id = $this->route('id') ?? $this->route('manufacturing_product') ?? $this->route('product');

        return [
            'name' => 'sometimes|required|string|max:255',
            'manufacturing_product_category_id' => 'sometimes|required|exists:manufacturing_product_categories,id',
            'code' => ['nullable', 'string', 'max:50', Rule::unique('manufacturing_products', 'code')->ignore($id)],
