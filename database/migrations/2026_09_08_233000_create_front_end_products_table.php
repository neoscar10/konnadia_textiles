...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('front_end_product_components', function (Blueprint $table) {
            $table->id();
            $table->foreignId('front_end_product_id')->constrained('front_end_products')->cascadeOnDelete();
        ...
        Schema::create('finished_goods_batch_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('finished_goods_batch_id')->constrained('finished_goods_batches')->cascadeOnDelete();
            $table->foreignId('manufacturing_product_id')->constrained('manufacturing_products')->cascadeOnDelete();
