...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('front_end_products')) {
        ...
        if (!Schema::hasTable('front_end_product_components')) {
        ...
        if (!Schema::hasTable('front_end_product_packagings')) {
        ...
        if (!Schema::hasTable('finished_goods_batches')) {
        ...
        if (!Schema::hasTable('finished_goods_batch_items')) {
        ...
        if (!Schema::hasTable('finished_goods_batch_packagings')) {
